...
class SampleAtm
{
	...
	public static void transfer (SampleAtm from, SampleAtm to, double amount)
	{
   		 from.wdamt(amount);
   		 to.depamt(amount);
	...
	public static void main(String []args)
	{
		...
		SampleAtm from=new SampleAtm();
		SampleAtm to=new SampleAtm();
...
interface ATMOperations
{
	...
	public void depamt(double depamt);
	public void showstmt();
	public void transfer(SampleAtm from,SampleAtm to,double amount);
}